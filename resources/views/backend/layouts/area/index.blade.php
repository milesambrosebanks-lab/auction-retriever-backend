@extends('backend.app', ['title' => 'Area'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.area.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.area.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.area.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush