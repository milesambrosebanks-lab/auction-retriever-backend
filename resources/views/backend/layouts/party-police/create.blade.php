@extends('backend.app', ['title' => 'Policy'])
                ...
                <div class="col-lg-12">
                    <div class="card post-sales-main">
                        <div class="card-header border-bottom">
                            <h3 class="card-title mb-0">Create Policy</h3>
                            <div class="card-options">
                                <a href="javascript:window.history.back()" class="btn btn-sm btn-primary">Back</a>
                            </div>
                        </div>
                        <div class="card-body border-0">
                            <form class="form form-horizontal" method="POST" action="{{ route('admin.party.police.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="dropify form-control @error('pdf_file') is-invalid @enderror" name="pdf_file" id="pdf_file">
                                                @error('pdf_file')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
