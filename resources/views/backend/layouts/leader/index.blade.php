@extends('backend.app', ['title' => 'Leader'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.leader.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0 wp-15">Leader</th>
...
<script>
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.leader.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
