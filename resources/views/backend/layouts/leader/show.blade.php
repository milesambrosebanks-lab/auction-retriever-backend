                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th>Thumbnail</th>
                                    <td>
                                        <a href="{{ asset($leader->thumbnail ?? 'default/logo.png') }}" target="_blank"><img src="{{ asset($leader->thumbnail ?? 'default/logo.png') }}" alt="" width="100" height="100" class="img-fluid"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Content</th>
