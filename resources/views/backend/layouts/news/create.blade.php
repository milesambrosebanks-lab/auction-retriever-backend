                ...
                <div class="col-lg-12">
                    <div class="card post-sales-main">
                        ...
                        <div class="card-body border-0">
                            <form class="form form-horizontal" method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    ...
                                    <div class="row" id="linkContainer">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" placeholder="Enter here Link" id="Link" value="{{ old('link') ?? '' }}">
                                                @error('link')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
