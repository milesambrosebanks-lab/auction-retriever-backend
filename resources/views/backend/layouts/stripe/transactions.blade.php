...
<div class="app-content main-content mt-0">
    <div class="side-app">
        <div class="main-container container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.stripe.transactions') }}"
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 d-flex align-items-end gap-2 flex-wrap">
                            <button class="btn btn-success btn-sm px-3" type="submit"><i
                                    class="fe fe-filter me-1"></i>Apply</button>
                            <a href="{{ route('admin.stripe.transactions') }}"
                                class="btn btn-light btn-sm px-3">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card transaction-sales-main">
                        ...
                        <table class="table table-bordered table-striped align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge bg-{{ ($txn->status ?? '') === 'pending' ? 'warning text-dark' : 'success' }}">{{
                                            ucfirst($txn->status ?? 'succeeded') }}</span></td>
                                    <td>{{ \Carbon\Carbon::createFromTimestamp($txn->created)->format('d M Y, h:i A') }}
                                    </td>
                                </tr>
                                @empty
                                <tr>
                ...
                <div
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.stripe.transactions', array_filter([
