@extends('backend.app', ['title' => 'Event'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.event.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.event.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.event.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
    function ShowEventRegisterList(id) {
        let url = "{{ route('admin.event.register.index', ':event_id') }}";
        window.location.href = url.replace(':event_id', id);
    }
</script>
@endpush