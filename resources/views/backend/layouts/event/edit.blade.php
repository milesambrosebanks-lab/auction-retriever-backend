                    ...
                    <div class="card post-sales-main">
                        ...
                        <div class="card-body border-0">
                            <form class="form form-horizontal" method="POST"
                                action="{{ route('admin.event.update', $event->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control @error('created_at') is-invalid @enderror" name="created_at" placeholder="Enter here date" id="created_at" value="{{ $event->created_at ?? '' }}">
                                                @error('created_at')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="summernote form-control @error('description') is-invalid @enderror" name="description" id="description"
                                                    placeholder="Enter here description" rows="3">{{ $event->description ?? '' }}</textarea>
                                                @error('description')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file"
                                                    data-default-file="{{ $event->thumbnail ? url($event->thumbnail) : url('default/logo.png') }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="sub_title" id="sub_title" placeholder="Enter here sub title"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Enter here organizer name"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="venue" id="venue" placeholder="Enter here venue"
                                                    value="{{ $event->venue ?? '' }}">
                                                @error('venue')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('speakers') is-invalid @enderror" name="speakers[]" id="speakers" multiple>
                                                    @foreach ($leaders as $leader)


                                                    <option value="{{ $leader->id }}" {{ in_array($leader->id, old('speakers', $event->speakers->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                        {{ $leader->name }}
                                                    </option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('registration_enabled') is-invalid @enderror"
                                                    ...
                                                    <option value="yes" {{ $event->registration_enabled == 'yes' ? 'selected' : '' }}>Yes</option>
                                                    <option value="no" {{ $event->registration_enabled == 'no' ? 'selected' : '' }}>No</option>
                                                </select>
