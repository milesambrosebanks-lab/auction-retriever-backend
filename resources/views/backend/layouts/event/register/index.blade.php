@extends('backend.app', ['title' => 'Event Register'])

@push('styles')
@include('backend.layouts.event.register._style')
@endpush
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.event.register.create', $event_id) }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.event.register.index', ['event_id' => $event_id]) }}",
                    type: "GET",
                },
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.event.register.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.event.register.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush