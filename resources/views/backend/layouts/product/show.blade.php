                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    <th>Thumbnail</th>
                                    <td>
                                        <a href="{{ asset($product->thumbnail ?? 'default/logo.png') }}" target="_blank"><img src="{{ asset($product->thumbnail ?? 'default/logo.png') }}" alt="" width="50" height="50" class="img-fluid"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Title</th>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $product->one_time_price ?? 'N/A' }}</td>
                                </tr>
                                 <tr>
                                    <th>Monthly Price</th>
                                    <td>{{ $product->monthly_price ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Supply Days</th>
                                    <td>{{ $product->supply_days ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Stock</th>
                                ...
                                @foreach ($product->bundleItems as $items)
                                    <tr>
                                        <th>Bundle Item <span class="badge bg-dark"> {{ $loop->iteration }}</span></th>
                                        <td>
                                            {{ $items->title }}
                                        </td>
                                    </tr>
