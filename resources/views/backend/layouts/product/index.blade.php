@extends('backend.app', ['title' => 'Product'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                {{-- <a href="{{ route('admin.product.create.single') }}" class="btn btn-primary btn-sm">Add</a> --}}
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    ...
    function goToEdit(id) {
        let url = "{{ route('admin.product.edit.single', ':id') }}";
