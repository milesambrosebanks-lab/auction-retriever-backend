@extends('backend.app', ['title' => 'Permission'])
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <form action="{{ route('admin.permissions.destroy', $permission->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger" style="border-radius: 0; border-top-right-radius: 5px; border-bottom-right-radius: 5px;"><i class="mdi mdi-delete"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
