                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-body d-grid gap-2">
                                <a href="{{ $listing->source_url }}" target="_blank" class="btn btn-success">
                                    <i class="fa fa-external-link me-1"></i>
                                    View on Bid4Assets
                                </a>
                                <a href="{{ route('admin.auction.listings.index') }}" class="btn btn-outline-secondary">
                            ...
                            <div class="card-body">
                                ...
                                @if ($listing->time_left)
                                    ...
                                    <div class="text-center">
                                        <span
                                            class="badge bg-{{ str_contains($listing->time_left, 'hrs') ? 'danger' : 'warning' }} fs-12">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <strong
                                            class="{{ $listing->auction_date && \Carbon\Carbon::parse($listing->auction_date)->isPast() ? 'text-danger' : 'text-success' }}">
                                            {{ $listing->auction_date ? \Carbon\Carbon::parse($listing->auction_date)->format('d M Y, h:i A') : '—' }}
                                        </strong>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        @if ($listing->time_left)
                                            <span
                                                class="badge bg-{{ str_contains($listing->time_left, 'hrs') ? 'danger' : 'warning' }}">
                                                {{ $listing->time_left }}
                                            </span>
                                        @else
                                            <strong>—</strong>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <strong>
                                            {{ $listing->scraped_at ? $listing->scraped_at->diffForHumans() : '—' }}
                                        </strong>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        @php
                                            $host = parse_url($listing->source_url, PHP_URL_HOST); // e.g. www.auction.com
                                            $host = preg_replace('/^www\./', '', $host); // auction.com
                                            $domainName = preg_replace('/\.[a-z]+$/', '', $host); // auction
                                        @endphp
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{ $listing->source_url }}" target="_blank"
