@extends('backend.app', ['title' => 'Party Resource'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.party.resource.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.party.resource.index') }}",
                    type: "GET",
                },
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.party.resource.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.party.resource.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush
