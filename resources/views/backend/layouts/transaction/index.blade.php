                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0 wp-15">Trx ID</th>
                                            <th class="bg-transparent border-bottom-0 ">Order number</th>
                                            <th class="bg-transparent border-bottom-0 ">User</th>
                                            <th class="bg-transparent border-bottom-0">Gateway</th>
...
<script>
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.transaction.show', ':id') }}";
