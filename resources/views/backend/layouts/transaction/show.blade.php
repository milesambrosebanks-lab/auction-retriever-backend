                            ...
                            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <th>Invoice PDF</th>
                                        <td>
                                            <a href=" {{ $transaction->invoice_pdf }}" target="_blank">Request Download</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ $transaction->hosted_invoice_urlnk}}">View Invoice</a>
                                            ...
                                            @if ($transaction->metadata_json != null)
                                                @foreach ($transaction->metadata_json as $key => $value)
                                                    @if ($key == 'product' && $value != null)
                                                        <a href="{{ route('admin.product.show', $value) }}"
                                                            class="btn btn-primary">View Product</a>
                                                    @endif
                                                    @if ($key == 'owner' && $value != null)
                                                        <a href="{{ route('admin.users.show', $value) }}"
                                                            class="btn btn-primary">View Owner</a>
                                                    @endif
                                                    ...
                                                    @if ($key == 'booking' && $value != null)
                                                        <a href="{{ route('admin.booking.show', $value) }}"
                                                            class="btn btn-primary">View Booking</a>
                                                    @endif
                                                @endforeach
                                            @endif
                                        </td>
