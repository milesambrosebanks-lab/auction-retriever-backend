                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" method="POST" action="{{ route($url.'.content') }}" enctype="multipart/form-data">
                                ...
                                <div class="row {{ in_array('name', $component) ? '' : 'd-none' }}">
                                    <div class="col-md-12">
                                        <x-form.text name="name" label="Name" placeholder="Enter here name" :value="$data->name ?? ''" />
                                    </div>
                                </div>
                                ...
                                <div class="row {{ in_array('sub_description', $component) ? '' : 'd-none' }}">
                                    <div class="col-md-12">
                                        <x-form.textarea name="sub_description" label="Short Description" placeholder="Enter here short description" :value="$data->sub_description ?? ''" />
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-4  {{ in_array('btn_text', $component) ? '' : 'd-none' }}">
                                        <x-form.text name="btn_text" label="Tag Line" placeholder="Enter here Tag line" :value="$data->btn_text ?? ''" />
                                    </div>
