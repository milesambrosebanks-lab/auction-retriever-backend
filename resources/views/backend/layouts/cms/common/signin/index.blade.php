                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" method="POST" action="{{ route($url.'.content') }}" enctype="multipart/form-data">
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="btn_text" class="form-label">Button One:</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="btn_two_text" class="form-label">Button Two:</label>
                                            <input type="text" class="form-control @error('btn_two_text') is-invalid @enderror" name="btn_two_text" placeholder="Enter here Total User Title" id="btn_two_text" value="{{ $data->btn_two_text ?? '' }}">
                                            @error('btn_two_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
