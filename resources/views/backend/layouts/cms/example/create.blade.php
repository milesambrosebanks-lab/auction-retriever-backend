                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="summernote form-control @error('btn_text') is-invalid @enderror" name="btn_text" placeholder="Enter here button text" id="btn_text" value="{{ old('btn_text') }}">
                                                    @error('btn_text')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
