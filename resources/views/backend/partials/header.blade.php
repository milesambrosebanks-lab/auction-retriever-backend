                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="message-menu ps2 overflow-hidden">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('backend/images/users/1.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{asset('backend/images/users/15.jpg')}}">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('backend/images/users/12.jpg') }}">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('/backend/images/users/4.jpg') }}">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown"
                                    ...
                                    <span>
                                        <img src="{{asset(Auth::user()->avatar ?? 'default/profile.jpg')}}" alt="profile-user" class="avatar  profile-user brround cover-image">
                                    </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.setting.general.index') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                        <path
