    ...
    public function run(): void
    {
        if (app()->environment('local')) {
            ...
            DB::table('roles')->insert([
                ...
                ['id' => 3, 'name' => 'staff', 'slug' => 'staff', 'guard_name' => 'web'],
            ...
            DB::table('users')->insert([
                ...
                ['id' => 3, 'name' => 'Staff', 'slug' => 'staff', 'email' => 'staff@staff.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now(), 'is_owner' => '0'],
