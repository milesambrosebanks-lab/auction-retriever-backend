...
class PartyPoliceController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view("backend.layouts.party-police.index");
    }
    ...
    {
        return view('backend.layouts.party-police.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $police->pdf_file = $data['pdf_file'] ?? null;
            $police->save();
        ...
        return redirect()->route('admin.party.police.index')->with('t-success', 'police created successfully');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.layouts.party-police.show', compact('police'));
    }
    ...
    {
        $police = Police::findOrFail($id);
        return view('backend.layouts.party-police.edit', compact('police'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $police->pdf_file = $data['pdf_file'] ?? $police->pdf_file;
            $police->save();
        ...
        return redirect()->route('admin.party.police.edit', $police->id)->with('t-success', 'police updated successfully');
    }
