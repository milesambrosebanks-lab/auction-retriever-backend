...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Donate;
...
class DonateBannerController extends Controller
{
    protected $cmsService;

    public $name = "donate";
    public $section = "banner";
    public $page = PageEnum::DONATE;
    public $item = SectionEnum::DONATE_BANNER;
