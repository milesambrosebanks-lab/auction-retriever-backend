...
namespace App\Http\Controllers\Web\Backend\CMS\Web\NewsDetails;
...
class NewsDetailsRelatedPostController extends Controller
{
    protected $cmsService;

    public $name = "news_details";
    public $section = "relatedpost";
    public $page = PageEnum::NEWSDETAILS;
    public $item = SectionEnum::NEWSDETAILS_RELATED_POST;
