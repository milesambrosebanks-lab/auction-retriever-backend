...
namespace App\Http\Controllers\Web\Backend\CMS\Web\MeetOurLeaders;
...
class MeetOurLeadersRepresentativeController extends Controller
{
    protected $cmsService;

    public $name = "meeetourleaders";
    public $section = "representative";
    public $page = PageEnum::MEETOURLEADERS;
    public $item = SectionEnum::MEETOURLEADERS_REPRESENTATIVE;
