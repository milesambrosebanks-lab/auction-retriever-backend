...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Senator;
...
class SenatorBannerController extends Controller
{
    protected $cmsService;

    public $name = "senator";
    public $section = "banner";
    public $page = PageEnum::SENATOR;
    public $item = SectionEnum::SENATOR_BANNER;
