...
namespace App\Http\Controllers\Web\Backend\CMS\Web\JoinCmc;
...
class JoinCmcBannerController extends Controller
{
    protected $cmsService;

    public $name = "join_cmc";
    public $section = "banner";
    public $page = PageEnum::JOIN_CMC;
    public $item = SectionEnum::JOIN_CMC_BANNER;
