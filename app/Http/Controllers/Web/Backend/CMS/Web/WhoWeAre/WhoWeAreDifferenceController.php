...
class WhoWeAreDifferenceController extends Controller
{
    protected $cmsService;

    public $name = "whoweare";
    public $section = "difference";
    public $page = PageEnum::WHOWEARE;
    public $item = SectionEnum::WHOWEARE_DIFFERENCE;
    public $items = SectionEnum::WHOWEARE_DIFFERENCES;
    public $count = 12;
