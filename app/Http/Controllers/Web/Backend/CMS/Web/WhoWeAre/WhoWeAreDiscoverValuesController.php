...
namespace App\Http\Controllers\Web\Backend\CMS\Web\WhoWeAre;
...
class WhoWeAreDiscoverValuesController extends Controller
{
    protected $cmsService;

    public $name = "whoweare";
    public $section = "discover_values";
    public $page = PageEnum::WHOWEARE;
    public $item = SectionEnum::WHOWEARE_DISCOVER_VALUES;
    public $items = SectionEnum::WHOWEARE_DISCOVER_VALUESS;
    public $count = 12;
