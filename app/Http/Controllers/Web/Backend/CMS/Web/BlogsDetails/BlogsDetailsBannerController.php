...
namespace App\Http\Controllers\Web\Backend\CMS\Web\BlogsDetails;
...
class BlogsDetailsBannerController extends Controller
{
    protected $cmsService;

    public $name = "blogs_details";
    public $section = "banner";
    public $page = PageEnum::BLOGSDETAILS;
    public $item = SectionEnum::BLOGSDETAILS_BANNER;
