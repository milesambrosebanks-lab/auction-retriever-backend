...
class HomeFounderStoryController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->component = ['title', 'name', 'image', 'description', 'sub_description','sub_title', 'btn_text',];
        $this->section = SectionEnum::FOUNDER_STORY;
    }
    /**
    ...
    public function index()
    {
        ...
        return view("backend.layouts.cms.founder.index", ["data" => $data, "page" => $this->page->value, "section" => $this->section->value, "component" => $this->component, 'sections' => $this->sections]);
    }

    public function show($id)
    {
        $data = CMS::where('id', $id)->first();
        return view("backend.layouts.cms.founder.show", ["data" => $data, "page" => $this->page->value, "section" => $this->section->value]);
    }
