...
class HomeEducationApproachController extends Controller
{
    use ApiResponse;
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->component = ['title', 'sub_title', 'description', 'image','bg'];
        $this->section = SectionEnum::EDUCATION_APPROACH;
    }
