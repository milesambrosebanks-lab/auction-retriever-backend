...
namespace App\Http\Controllers\Web\Backend\CMS\Web\ShopDetails;
...
class ShopDetailsRelatedPostController extends Controller
{
    protected $cmsService;

    public $name = "shop_details";
    public $section = "relatedpost";
    public $page = PageEnum::SHOPDETAILS;
    public $item = SectionEnum::SHOPDETAILS_RELATED_POST;
