...
namespace App\Http\Controllers\Web\Backend\CMS\Web\ContactUs;
...
class ContactUsOfficeController extends Controller
{
    protected $cmsService;

    public $name = "contact_us";
    public $section = "office";
    public $page = PageEnum::CONTACT_US;
    public $item = SectionEnum::CONTACT_US_OFFICE;
