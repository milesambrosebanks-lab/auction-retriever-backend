...
namespace App\Http\Controllers\Web\Backend\CMS\Web\MeetOurLeadersDetails;
...
class MeetOurLeadersDetailsRelatedPostController extends Controller
{
    protected $cmsService;

    public $name = "meeetourleadersdetails";
    public $section = "relatedpost";
    public $page = PageEnum::MEETOURLEADERSDETAILS;
    public $item = SectionEnum::MEETOURLEADERSDETAILS_RELATED_POST;
