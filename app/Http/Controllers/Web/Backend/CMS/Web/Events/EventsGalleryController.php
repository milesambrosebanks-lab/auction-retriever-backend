...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Events;
...
class EventsGalleryController extends Controller
{
    protected $cmsService;

    public $name = "events";
    public $section = "gallery";
    public $page = PageEnum::EVENTS;
    public $item = SectionEnum::EVENTS_GALLERY;
