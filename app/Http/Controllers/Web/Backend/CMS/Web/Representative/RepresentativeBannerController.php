...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Representative;
...
class RepresentativeBannerController extends Controller
{
    protected $cmsService;

    public $name = "representative";
    public $section = "banner";
    public $page = PageEnum::REPRESENTATIVE;
    public $item = SectionEnum::REPRESEMENTATIVE_BANNER;
