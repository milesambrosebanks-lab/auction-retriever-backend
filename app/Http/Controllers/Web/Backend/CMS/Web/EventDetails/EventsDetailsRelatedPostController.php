...
namespace App\Http\Controllers\Web\Backend\CMS\Web\EventDetails;
...
class EventsDetailsRelatedPostController extends Controller
{
    protected $cmsService;

    public $name = "events_details";
    public $section = "relatedpost";
    public $page = PageEnum::EVENTSDETAILS;
    public $item = SectionEnum::EVENTSDETAILS_RELATED_POST;
