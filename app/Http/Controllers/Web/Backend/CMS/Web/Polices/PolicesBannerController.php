...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Polices;
...
class PolicesBannerController extends Controller
{
    protected $cmsService;

    public $name = "polices";
    public $section = "banner";
    public $page = PageEnum::POLICES;
    public $item = SectionEnum::POLICES_BANNER;
