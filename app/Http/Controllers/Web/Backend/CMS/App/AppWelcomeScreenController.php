...
class AppWelcomeScreenController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->page = PageEnum::APP_WELCOME;

        $this->component = ['title', 'sub_title', 'bg', 'description', 'btn_text'];
        $this->section = SectionEnum::SCREEN;
    }
