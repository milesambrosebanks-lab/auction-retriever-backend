...
class AppWhoWeAreDiscoverController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->section = SectionEnum::DISCOVER;

        $this->sections = SectionEnum::DISCOVERS;
        $this->components = ['title', 'description'];
        $this->count = 10;
    }
    /**
