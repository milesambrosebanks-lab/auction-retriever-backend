...
namespace App\Http\Controllers\Web\Backend\CMS\App;
...
class AppWhoWeAreMessionAndVisionController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->page = PageEnum::APP_WHO_WE_ARE;

        $this->component = ['title'];
        $this->section = SectionEnum::MESSION_AND_VISION;

        $this->sections = SectionEnum::MESSION_AND_VISIONS;
        $this->components = ['title', 'description', 'image'];
        $this->count = 100;
    }
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view("backend.layouts.cms.index", ["data" => $data, "page" => $this->page, "section" => $this->section->value, "component" => $this->component, 'sections' => $this->sections]);
    }
    ...
    {
        return view("backend.layouts.cms.create", ["page" => $this->page, "section" => $this->section->value, "components" => $this->components]);
    }
    ...
    public function store(CmsRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route("admin.cms.app.{$this->page}.{$this->section->value}.index")->with('t-success', 'Created successfully');
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        ...
        return view("backend.layouts.cms.show", ["data" => $data, "page" => $this->page, "section" => $this->section->value]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view("backend.layouts.cms.update", ["data" => $data, "page" => $this->page, "section" => $this->section->value, "components" => $this->components]);
    }
    ...
    public function update(CmsRequest $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route("admin.cms.app.{$this->page}.{$this->section->value}.index")->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
