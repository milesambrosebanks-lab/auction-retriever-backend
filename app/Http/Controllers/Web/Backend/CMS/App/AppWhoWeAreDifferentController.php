...
class AppWhoWeAreDifferentController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->section = SectionEnum::DIFFERENT;

        $this->sections = SectionEnum::DIFFERENTS;
        $this->components = ['title', 'image', 'description'];
        $this->count = 10;
    }
    /**
