...
if (!function_exists('jsonErrorResponse')) {
    function jsonErrorResponse(string $message, int $code = 400, array $errors = [])
    {
        $response = [
            'status'  => false,
            'code'    => $code,
...
if (!function_exists('jsonResponse')) {
    function jsonResponse(bool $status, string $message, int $code, $data = null, bool $paginate = false, $paginateData = null)
    {
        $response = [
            'status'  => $status,
            'message' => $message,
